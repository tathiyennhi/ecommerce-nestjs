...
//   const childProducteRepository = dataSource.getRepository(ChildProduct);
  ...
  const menuMale = queryRunner.manager.create(Menu, { name: "Thời trang nam" });
  const menuFemale = queryRunner.manager.create(Menu, { name: "Thời trang nữ" });
  const menuSale = queryRunner.manager.create(Menu, { name: "SALE" });
  const menuIntroduce = queryRunner.manager.create(Menu, { name: "Giới thiệu" });
  ...
  // For child product
  const productMaleTrousersRedSizeS = queryRunner.manager.create(ChildProduct, {
  ...
  const productMaleTrousersRedSizeM = queryRunner.manager.create(ChildProduct, {
    name: "Quần Dài Nam Thể Thao Pro Active",
    price: 100000,
    color: "red",
    size: "M",
  ...
  const productMaleTrousersGreebSizeS = queryRunner.manager.create(ChildProduct, {
    name: "Quần Dài Nam Thể Thao Pro Active",
    price: 100000,
    color: "green",
    size: "S",
  ...
  const productMaleTrousersGreenSizeM = queryRunner.manager.create(ChildProduct, {
    name: "Quần Dài Nam Thể Thao Pro Active",
    price: 100000,
    color: "green",
    size: "M",
  ...
  const productFemaleTrousersRedSizeS = queryRunner.manager.create(ChildProduct, {
  ...
  const productFemaleTrousersRedSizeM = queryRunner.manager.create(ChildProduct, {
    name: "Quần Dài Nữ Thể Thao Pro Active",
    price: 100000,
    color: "red",
    size: "M",
  ...
  const roleAdmin = queryRunner.manager.create(Role, {name: "admin", created_by: "init-process", updated_by: "init-process"});
  const superAdminRole = queryRunner.manager.create(Role, {name: "super-admin", created_by: "init-process", updated_by: "init-process"});
  const roleUser = queryRunner.manager.create(Role, {name: "user", created_by: "init-process", updated_by: "init-process"});
  await queryRunner.manager.save([roleAdmin, roleUser, superAdminRole]);

  const handleMenu = queryRunner.manager.create(Permission, {name: "HANDLE_MENU", created_by: "init-process", updated_by: "init-process"}); // CRUD
  const handleCate = queryRunner.manager.create(Permission, {name: "HANDLE_CATEGORY", created_by: "init-process", updated_by: "init-process"});
  const handleProductType = queryRunner.manager.create(Permission, {name: "HANDLE_PRODUCT_TYPE", created_by: "init-process", updated_by: "init-process"});
  const handleProduct = queryRunner.manager.create(Permission, {name: "HANDLE_PRODUCT", created_by: "init-process", updated_by: "init-process"});
  const handleChildProduct = queryRunner.manager.create(Permission, {name: "HANDLE_CHILD_PRODUCT", created_by: "init-process", updated_by: "init-process"});
  const handleAdmin = queryRunner.manager.create(Permission, {name: "HANDLE_ADMIN", created_by: "init-process", updated_by: "init-process"});
  await queryRunner.manager.save([handleMenu, handleCate, handleProductType, handleProduct, handleChildProduct, handleAdmin]);


  const createMenuRoute = queryRunner.manager.create(Route, { method: "POST", route: "/menu", created_by: "init-process", updated_by: "init-process"})
  const createCategoryRoute = queryRunner.manager.create(Route, { method: "POST", route: "/category", created_by: "init-process", updated_by: "init-process"})
  const createProductTypeRoute = queryRunner.manager.create(Route, { method: "POST", route: "/product-types", created_by: "init-process", updated_by: "init-process"})
  const createProductRoute = queryRunner.manager.create(Route, { method: "POST", route: "/product", created_by: "init-process", updated_by: "init-process"})
  const createChildProductRoute = queryRunner.manager.create(Route, { method: "POST", route: "/child-product", created_by: "init-process", updated_by: "init-process"})
  ...
  await queryRunner.manager.save([createMenuRoute, createCategoryRoute, createProductTypeRoute, createProductRoute, createChildProductRoute])
  
  // create super admin -> admin with full system permission
  console.log('add super admin')
  const superAdmin = queryRunner.manager.create(Admin, { email: "caonhungoc1996@gmail.com", name: "super-admin", created_by: "init-process", updated_by: "init-process", password: Utils.md5Hash(superAdminPass)});
  superAdmin.roles=[superAdminRole]; // created_by
  superAdmin.permissions=[handleMenu, handleCate, handleProductType, handleProduct, handleChildProduct]; // created_by
  await queryRunner.manager.save([superAdmin]);
  console.log("DONE add super admin '\n' ")

  console.log('add admin')
  const admin = queryRunner.manager.create(Admin, { email: "admin00@gmail.com", name: "admin-00", created_by: "init-process", updated_by: "init-process", password: Utils.md5Hash(superAdminPass)});
  admin.roles=[roleAdmin]; // created_by
  admin.permissions=[handleMenu, handleCate, handleProductType, handleProduct, handleChildProduct]; // created_by
