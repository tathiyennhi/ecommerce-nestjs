...
export async function seedData(dataSource: DataSource): Promise<void> {
  ...
  // For child product
  const productMaleTrousersRedSizeS = childProducteRepository.create({
  ...
  const productMaleTrousersRedSizeM = childProducteRepository.create({
    name: "Quần Dài Nam Thể Thao Pro Active",
    price: 100000,
    color: "red",
    size: "M",
  ...
  const productMaleTrousersGreebSizeS = childProducteRepository.create({
    name: "Quần Dài Nam Thể Thao Pro Active",
    price: 100000,
    color: "green",
    size: "S",
  ...
  const productMaleTrousersGreenSizeM = childProducteRepository.create({
    name: "Quần Dài Nam Thể Thao Pro Active",
    price: 100000,
    color: "green",
    size: "M",
  ...
  await childProducteRepository.save([
  ...
  const productFemaleTrousersRedSizeS = childProducteRepository.create({
  ...
  const productFemaleTrousersRedSizeM = childProducteRepository.create({
    name: "Quần Dài Nữ Thể Thao Pro Active",
    price: 100000,
    color: "red",
    size: "M",
